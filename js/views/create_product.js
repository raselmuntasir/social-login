            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-100">
                ...
                <div class="p-4 space-y-4">
                    ...
                    <div>
                        ...
                        <select id="prod-group" class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-purple-500 bg-white text-gray-700">
                    ...
                    <div>
                        ...
                        <input type="number" id="prod-followup" value="0" class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-purple-500">
                    </div>
